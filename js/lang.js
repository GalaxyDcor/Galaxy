...
const translations = {
  en: {
    ...
    serviceTitles: [
      ...
      "Floor Wall & <br> <span>Tiling</span>",
  ...
  ar: {
    ...
    contact: "اتصل بنا",
    ourServices: "خدماتنا",
    falseCeiling: "تركيب الأسقف المعلقة و الفواصل الخفيفة ",
    plumbing: "تركيب الأرضيات الخشبية و أعمال الدهان",
    plumbing2: "تركيب أعمال السباكة والصرف الصحي",
    airConditioning: "أنظمة التكييف والتهوية و تنقية الهواء",
    engraving: "  أعمال الحفر والزخرفة",
    electrical: " صيانة التركيبات الكهربائية و تركيب ورق الحائط",
    electrotechnical: "تركيب وصيانة المعدات الكهروتقنية",
    plaster: "أعمال المحاره وتثبيت ورق الحائط",
    serviceTitles: [
      " تركيب الأسقف المعلقة و <br><span>الفواصل الخفيفة</span>",
      "تركيب الأرضيات الخشبية و <br><span>أعمال الدهان</span>",
      "أنظمة التكييف والتهوية <br> <span>و تنقية الهواء</span>",
      "  أعمال الحفر و <br><span>الزخرفة</span>",
      "تركيب أعمال السباكة و <br><span>الصرف الصحي</span>",
      "صيانة التركيبات الكهربائية و <br><span>تركيب ورق الحائط</span>",
      "تركيب وصيانة و <br><span>المعدات الكهروتقنية</span>",
      "أعمال المحاره و <br><span>تثبيت ورق الحائط</span>"
    ],
    aboutTitle: "من نحن",
    ...
    address: "الإمارات العربية المتحدة<br>دبي<br>مساكن شاطئ جميرا",
    Link: "روابط سريعة",
